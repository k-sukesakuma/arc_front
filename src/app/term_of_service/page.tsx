					...
					<div className="shadow-md px-6 py-4 mx-20 rounded-lg bg-white">
						...
						<div>
							<div className="px-4 py-3 font-semibold rounded-lg hover:bg-slate-200">
								...
								<br></br>
								<br></br>
								)は、本サービス(本サイトを含むものとし、以下、特に両者を区別しません。
								<br></br>)の利用条件を定めるものです。<br></br>
								<br></br>
								<br></br>
								<br></br>
								<br></br>
								...
								その他、当社が利用登録を相当でないと判断した場合<br></br>
								...
								<br></br>
								<br></br>
								当社は、ログイン情報が第三者によって使用されたことによって生じた損害につき、当社に故意又は重大な過失がある場合を除き、一切の責任を負いません。
								<br></br>
								<br></br>
								コンテンツのご利用
								...
								<br></br>これは、譲渡及び再許諾できない、非独占的な利用権です。
								<br></br>
								...
								<br></br>
								ユーザーの投稿
								ユーザーは、ユーザーの投稿に含まれる情報を送信することについて適法な権利を有していること、及びユーザーの投稿が第三者の知的財産権（著作権、特許権、実用新案権、商標権、意匠権（それらの権利を取得し、又はそれらの権利につき登録等を出願する権利を含みます。
								<br></br>）又はアイデア、ノウハウ等をいい、以下同様とします。
								<br></br>
								）、所有権その他の権利を侵害していないことについて、当社に対し表明し、保証するものとします。
								<br></br>
								ユーザーの投稿に関する著作権は、ユーザー自身に留保されます。
								<br></br>
								当社はユーザーの投稿に関して著作権を取得することはありません。
								<br></br>
								...
								<br></br>•
								自ら（法人その他の団体にあっては、自らの役員を含みます。
								<br></br>
								）が、暴力団、暴力団員、暴力団員でなくなった時から5年を経過しない者、暴力団準構成員、暴力団関係企業、総会屋、社会運動等標ぼうゴロまたは特殊知能暴力集団等その他これらに準じる者（以下総称して「暴力団員等」といいます。
								<br></br>）であること •
								...
								<br></br>• 暴力的な要求行為 • 法的な責任を超えた不当な要求行為 •
								...
								<br></br>
								消費者契約に該当する場合であっても、当社は、当社の過失（重過失を除きます。
								<br></br>
								）によってユーザーに生じた損害のうち、ユーザーに直接かつ現実に発生した損害についてのみ賠償責任を負うものとし、また、その賠償額は、本サービスの利用料金の直近1ヶ月分または金1万円のいずれか低い方を上限とします。
								<br></br>
								サービス内容の変更
								...
								<br></br>
								事業譲渡
								当社は本サービスにかかる事業を他社に事業譲渡（事業譲渡、会社分割その他事業が移転するあらゆる場合を含みます。
								<br></br>
								）した場合には、当該事業譲渡に伴い利用契約上の地位、本規約に基づく権利及び義務並びにユーザーの情報を当該事業譲渡の譲受人に譲渡することができるものとします。
								<br></br>
								ユーザーは、かかる譲渡につき予め同意したものとみなします。
								<br></br>
								適用関係
