		...
		<div>
			<main className="flex bg-slate-100 relative">
				...
				<section className="flex-grow">
					...
					<div className="shadow-md px-6 py-4 mx-20 rounded-lg bg-white mb-5">
						<div>
							<div className="px-4 py-3 rounded-lg">
								<p>
									この利用規約(以下、「本規約」といいます。)<br></br>
									は、本サービス(本サイトを含むものとし、以下、特に両者を区別しません。)の利用条件を定めるものです。本規約は、本サービスを利用するすべてのユーザーに適用されます。
								</p>

								<h2 className="text-xl font-bold mt-2 mb-2">本規約への同意</h2>
								<p>
									ユーザーは、本サービスを利用することによって、本規約に有効かつ取り消し不能な同意をしたものとみなされます。本規約に同意しないユーザーは、本サービスをご利用いただけません。
								</p>

								<h2 className="text-xl font-bold mt-2 mb-2">利用登録</h2>
								<p>
									本サービスの利用を希望する方は、本規約に同意の上、当社の定める方法によって利用登録を申請し、当社がこれを承認することによって、本サービスの利用登録をすることができます。
								</p>

								<h2 className="text-xl font-bold mt-2 mb-2">登録拒否</h2>
								<p>
								...
								<p>
									ユーザーが未成年である場合には、法定代理人の同意を得た上で、本サービスを利用してください。本サービスのご利用にあたり必要となるスマートフォンその他デバイスについても、必ず法定代理人の同意を得た上でご使用下さい。未成年者であった間の利用行為を追認したものとみなします。
								</p>
								...
								<h2 className="text-xl font-bold mt-2 mb-2">遅延損害金</h2>
								<p>
								...
								<>
									...
									<h3 className="text-xl font-bold mt-2 mb-2">禁止事項</h3>
									<p>
								...
								<div>
									<p>
										...
										<h3 className="text-xl font-bold mt-2 mb-2">利用制限</h3>
